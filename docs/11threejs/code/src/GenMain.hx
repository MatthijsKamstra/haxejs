...
class GenMain {
	...
	public function new () {
		...
		var material = new MeshBasicMaterial( { color: "#433F81",wireframe:true,transparent:true } );
		...
		var geometry = new BoxGeometry( 3,3,3 );
		var material = new MeshBasicMaterial( { color: "#A49FEF",wireframe:true,transparent:true } );
